                  ...
                  <div className="checkoutPaymentContainer">
                    ...
                    <label>
                      ...
                      <div className="checkoutPaymentMethod">
                        ...
                        <p>
                          Check payment, also known as a cheque payment,
                          is a traditional method of transferring funds where the payer (or drawer) writes a check to a payee (or recipient)
                          instructing their bank to pay a specific amount from the payer's 
                          account to the payee's account or a designated person or entity.
                          This written order serves as a substitute for physical currency,
                          facilitating monetary transactions without requiring the physical handling of cash.
                        </p>
                      </div>
                    </label>
                    <label>
                      ...
                      <div className="checkoutPaymentMethod">
                        ...
                        <p>
                          Cash on delivery (COD) is a payment method where a customer pays for goods or services when they are delivered, 
                          rather than paying in advance. 
                          This means the customer receives the item and then makes the payment, usually in cash, to the delivery person.
                        </p>
                      </div>
                    </label>
                    <label>
                      ...
                      <div className="checkoutPaymentMethod">
                        <span>Paypal</span>
                        <p>
                          PayPal payments refer to transactions conducted through the PayPal online payment platform. 
                          It allows users to send and receive money online, often for purchases made on websites or in person. 
                          PayPal serves as a secure intermediary, enabling transactions without sharing full financial information.
                        </p>
                      </div>
                    </label>
