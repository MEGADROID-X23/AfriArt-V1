...
const Filter = () => {
  ...
  const [brandsData] = useState([
    { name: "Hanifa", count: 2 },
    { name: "DEOLA", count: 7 },
    { name: "Sai Sankoh", count: 10 },
    { name: "David Tlale", count: 39 },
    { name: "WUMAN", count: 95 },
    { name: "Lisa Folawiyo Studio", count: 1092 },
    { name: "Thebe Magugu", count: 48 },
  ]);
      ...
      <div className="filterSection">
        <div className="filterCategories">
          <Accordion defaultExpanded disableGutters elevation={0}>
            ...
            >
              <h5 className="filterHeading">Art Categories</h5>
            </AccordionSummary>
        ...
        <div className="filterColors">
          <Accordion defaultExpanded disableGutters elevation={0}>
            <AccordionSummary
              ...
              sx={{ padding: 0, marginBottom: 2 }}
            >
              <h5 className="filterHeading">Art Sizes</h5>
            </AccordionSummary>
            <AccordionDetails sx={{ padding: 0 }}>
        ...
        <div className="filterBrands">
          <Accordion defaultExpanded disableGutters elevation={0}>
            <AccordionSummary
              ...
              sx={{ padding: 0, marginBottom: 2 }}
            >
              <h5 className="filterHeading">Art Brands</h5>
            </AccordionSummary>
            <AccordionDetails sx={{ padding: 0 }}>
              {/* Search bar */}
